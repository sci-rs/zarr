...
impl<S: ReadableStore + Hierarchy> HierarchyReader for S {
        ...
        T: ReflectedType,
    {
        ...
        value_reader
            .map(|reader| {
                <crate::chunk::DefaultChunk as chunk::DefaultChunkReader<T, _>>::read_chunk(
                    reader,
                    array_meta,
                    grid_position,
                )
    ...
    >(
        ...
        value_reader
            .map(|reader| {
                <crate::chunk::DefaultChunk as chunk::DefaultChunkReader<T, _>>::read_chunk_into(
                    reader,
                    array_meta,
                    grid_position,
                    chunk,
...
impl<S: ReadableStore + WriteableStore + Hierarchy> HierarchyWriter for S {
    ...
    fn write_chunk<T: ReflectedType, B: DataChunk<T> + WriteableDataChunk>(
        ...
        self.set(&chunk_key, |writer| {
            <chunk::DefaultChunk as chunk::DefaultChunkWriter<T, _, _>>::write_chunk(
